...
public class TypeThreeMoreAdapter extends UltimateBaseAdapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, int position) {
        ...
        final TypeThreeItemBean.ConEntity conEntity = conList.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("name", conEntity.getAlbumName());
                bundle.putString("logoUrl", conEntity.getLogo());
                String albumId = conEntity.getAlbumId();
                bundle.putString("albumId", albumId);
                bundle.putString("providerCode", conEntity.getProviderId() + "");
